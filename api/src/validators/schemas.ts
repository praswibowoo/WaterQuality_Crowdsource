...
export const createSampleSchema = z.object({
  ...
  nitrate: z.number().min(0, 'Nitrate (NO₃⁻) must be at least 0 mg/L').max(6200, 'Nitrate (NO₃⁻) must be at most 6,200 mg/L').optional().nullable(),
  calcium: z.number().min(0, 'Calcium (Ca²⁺) must be at least 0 mg/L').max(4000, 'Calcium (Ca²⁺) must be at most 4,000 mg/L').optional().nullable(),
  potassium: z.number().min(0, 'Potassium (K⁺) must be at least 0 mg/L').max(2000, 'Potassium (K⁺) must be at most 2,000 mg/L').optional().nullable(),
  sodium: z.number().min(0, 'Sodium (Na⁺) must be at least 0 mg/L').max(2000, 'Sodium (Na⁺) must be at most 2,000 mg/L').optional().nullable(),
